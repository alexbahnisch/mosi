...
CPLEX_LP_SOLVER = CplexCliSolver("C:/Dev/IBM/CPLEX/12.7/cplex/bin/x64_win64/cplex.exe", "lp")
CPLEX_MPS_SOLVER = CplexCliSolver("C:/Dev/IBM/CPLEX/12.7/cplex/bin/x64_win64/cplex.exe", "mps")
