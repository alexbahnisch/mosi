...
from ..format import CbcSolutionFile, CbcSolutionReader, LpWriter, MpsWriter
...
class CbcCliSolver(CliSolver):
    ...
    def solve(self, model, directory=None, name=None, delete=True, message_callback=print, *args):
